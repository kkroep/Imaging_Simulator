/*
 * File: _coder_calculate_A_info.c
 *
...
/* Include files */
#include "_coder_calculate_A_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]C:/Users/Kees/Dropbox/Honours_Imaging program/calculate_A.m"), "context",
                0);
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1388460096U), "fileTimeLo", 2);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/div.p"), "resolved",
                8);
  emlrtAddField(*info, b_emlrt_marshallOut(1389307920U), "fileTimeLo", 8);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("calculate_A"));
...
/*
 * File trailer for _coder_calculate_A_info.c
 *
 * [EOF]
 */
