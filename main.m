...
[ A, Receiver_Data ] = Forward_Function( Transmitter_Loc, Receiver_Loc, frequentie, Source, x, y, z);
disp ('Forward function DONE');

%% Invserse (Reconstruct the image)
Pixel_Matrix =Inverse_Function( Receiver_Loc, Receiver_Data, frequentie, A);
